...
<!-- ======= Home Section ======= -->
  <section id="hero" class="hero d-flex align-items-center">
    <div class="container">
      <div class="row">
        <div class="col-xl-4">
          <h2 data-aos="fade-up">Branding for Startup Professional Industrial Businesses</h2>
          <blockquote data-aos="fade-up" data-aos-delay="100">
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perspiciatis cum recusandae eum laboriosam voluptatem repudiandae odio, vel exercitationem officiis provident minima. </p>
          </blockquote>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="videos/BSpib-Videos.mp4" class="btn-get-started glightbox btn-watch-video d-flex align-items-center">Get Started</a>
            <a href="videos/BSpib-Presentation-1.mp4" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 position-relative" data-aos="fade-up" data-aos-delay="200">
            <div class="phone-wrap">
              <img src="{{ asset('/img/iphone.png') }}" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="post-box">
              <div class="post-img"><img src="{{ asset('img/blog/blog-4.jpg') }}" class="img-fluid" alt=""></div>
              <div class="meta">
